...
@login @manual @regression
    Scenario: Navigation to technical support dropdown option under support
		And I choose technical support dropdown under support
    ...
    And I choose purchasing and licensing dropdown under support
    And I navigate to the contents of the page
    ...
    And I choose contact us dropdown under support
